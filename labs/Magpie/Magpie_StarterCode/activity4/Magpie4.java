...
public class Magpie4
{
	...
	private String transformIWantStatement(String statement)
	{
		...
		String[] whatUWant = restOfStatement.split(" ");
		String ret = "Would you really be happy if you had ";
		for(int i = 0; i<whatUWant.length;i++){
			ret+= whatUWant[i];
			ret+= " ";
		}
		return ret;
	...
	private String transformYouStatement(String statement)
	{
		...
		String remaining = statement.substring(psn+1,findKeyword(statement,"you",0)).trim();
