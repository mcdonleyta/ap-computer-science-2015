...
public class Magpie4
{
	...
	public String getResponse(String statement)
	{
		...
		if(findKeyword(statement, "dog") >= 0 || findKeyword(statement, "cat") >= 0 || findKeyword(statement, "fish") >= 0 || findKeyword(statement, "snake") >= 0)
		{
			response = "Tell me more about your pets.";
		}else 
		if(findKeyword(statement, "Mr. McDonley") >= 0) 
		{
			response = "Your teacher seems to be very helpful.";
		}else
		if (findKeyword(statement, "cousin") >= 0) 
		{
			response = "Tell me about your cousin";
		}else
		if(findKeyword(statement, "school") >= 0)
		{
			response = "Tell me about school, Village Academy.";
		}else
		if(findKeyword(statement, "book") >=0 || findKeyword(statement, "books") >= 0)
		{
		...
		{
			transformIDontWantToStatement(statement);
		}
	...
	private String transformILikeToStatement(String statement)
	{
		...
		String restOfStatement = statement.substring(psn + 9).trim();
		return "What would you like to " + restOfStatement + "?";
	}
	...
	private String transformIWantStatement(String statement)
	{
		...
		String restOfStatement = statement.substring(psn + 6).trim();
		return "What would it mean to want " + restOfStatement + "?";
	}
	...
	private String transformIDontWantToStatement(String statement)
	{
		...
		return "What would it mean to not " + restOfStatement + "?";
	}
