...
public class Magpie5
{
	...
	public String getResponse(String statement)
	{
		...
		}else if(findKeyword(statement, "dog") >= 0 || findKeyword(statement, "cat") >= 0 || findKeyword(statement, "fish") >= 0 || findKeyword(statement, "snake") >= 0)
		{
			response = "Tell me more about your pets.";
		}else  if(findKeyword(statement, "Mr. McDonley") >= 0) 
		{
			response = "Your teacher seems to be very helpful.";
		}else if (findKeyword(statement, "cousin") >= 0) 
		{
			response = "Tell me about your cousin";
		}else if(findKeyword(statement, "school") >= 0)
		{
			response = "Tell me about school, Village Academy.";
		}else if(findKeyword(statement, "book") >=0 || findKeyword(statement, "books") >= 0)
		{
	...
	private String [] randomResponses = 
	{
			...
			"You don't say.", 
			"You know, not everyone can pull that off.",
			"That’s so right up your alley.",
			"That sounds like something a plebian would say",
